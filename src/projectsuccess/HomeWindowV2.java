...
public class HomeWindowV2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable3.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student ID", "Full Name", "Postal Address", "Date of Birth", "Grade", "Phone No", "Sex", "Guardian's Name", "Guardian's Phone No"
            }
        ) {
            Class[] types = new Class [] {
        ...
        jTable4.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Teacher ID", "Full Name", "Name With Initial", "Postal Address", "Date of Birth", "Phone No", "Sex"
            }
        ) {
            Class[] types = new Class [] {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student ID", "Student  Name", "Subject", "Teacher's Name", "Subject Fee", "Last Paid Month"
            }
        ) {
            Class[] types = new Class [] {
